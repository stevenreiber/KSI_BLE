...
#include "cycfg_clocks.h"
    ...
    const cyhal_resource_inst_t peri_0_div_16_5_0_obj = 
    {
        .type = CYHAL_RSC_CLOCK,
        .block_num = peri_0_div_16_5_0_HW,
        .channel_num = peri_0_div_16_5_0_NUM,
    };
    ...
    const cyhal_resource_inst_t peri_0_div_8_7_obj = 
    {
        .type = CYHAL_RSC_CLOCK,
        .block_num = peri_0_div_8_7_HW,
        .channel_num = peri_0_div_8_7_NUM,
    };
...
void init_cycfg_clocks(void)
{
    ...
    Cy_SysClk_PeriphSetFracDivider(CY_SYSCLK_DIV_16_5_BIT, 0U, 107U, 16U);
...
{
#if defined (CY_USING_HAL)
    cyhal_hwmgr_reserve(&peri_0_div_16_5_0_obj);
    cyhal_hwmgr_reserve(&peri_0_div_8_0_obj);
    cyhal_hwmgr_reserve(&peri_0_div_8_1_obj);
    cyhal_hwmgr_reserve(&peri_0_div_8_7_obj);
#endif //defined (CY_USING_HAL)
}
